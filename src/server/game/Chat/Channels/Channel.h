...
{
    CHAT_JOINED_NOTICE                = 0x00,           //+ "{} joined channel.";
    CHAT_LEFT_NOTICE                  = 0x01,           //+ "{} left channel.";
    //CHAT_SUSPENDED_NOTICE             = 0x01,           // "{} left channel.";
    CHAT_YOU_JOINED_NOTICE            = 0x02,           //+ "Joined Channel: [{}]"; -- You joined
    //CHAT_YOU_CHANGED_NOTICE           = 0x02,           // "Changed Channel: [{}]";
    CHAT_YOU_LEFT_NOTICE              = 0x03,           //+ "Left Channel: [{}]"; -- You left
    CHAT_WRONG_PASSWORD_NOTICE        = 0x04,           //+ "Wrong password for {}.";
    CHAT_NOT_MEMBER_NOTICE            = 0x05,           //+ "Not on channel {}.";
    CHAT_NOT_MODERATOR_NOTICE         = 0x06,           //+ "Not a moderator of {}.";
    CHAT_PASSWORD_CHANGED_NOTICE      = 0x07,           //+ "[{}] Password changed by {}.";
    CHAT_OWNER_CHANGED_NOTICE         = 0x08,           //+ "[{}] Owner changed to {}.";
    CHAT_PLAYER_NOT_FOUND_NOTICE      = 0x09,           //+ "[{}] Player {} was not found.";
    CHAT_NOT_OWNER_NOTICE             = 0x0A,           //+ "[{}] You are not the channel owner.";
    CHAT_CHANNEL_OWNER_NOTICE         = 0x0B,           //+ "[{}] Channel owner is {}.";
    CHAT_MODE_CHANGE_NOTICE           = 0x0C,           //?
    CHAT_ANNOUNCEMENTS_ON_NOTICE      = 0x0D,           //+ "[{}] Channel announcements enabled by {}.";
    CHAT_ANNOUNCEMENTS_OFF_NOTICE     = 0x0E,           //+ "[{}] Channel announcements disabled by {}.";
    CHAT_MODERATION_ON_NOTICE         = 0x0F,           //+ "[{}] Channel moderation enabled by {}.";
    CHAT_MODERATION_OFF_NOTICE        = 0x10,           //+ "[{}] Channel moderation disabled by {}.";
    CHAT_MUTED_NOTICE                 = 0x11,           //+ "[{}] You do not have permission to speak.";
    CHAT_PLAYER_KICKED_NOTICE         = 0x12,           //? "[{}] Player {} kicked by {}.";
    CHAT_BANNED_NOTICE                = 0x13,           //+ "[{}] You are bannedStore from that channel.";
    CHAT_PLAYER_BANNED_NOTICE         = 0x14,           //? "[{}] Player {} bannedStore by {}.";
    CHAT_PLAYER_UNBANNED_NOTICE       = 0x15,           //? "[{}] Player {} unbanned by {}.";
    CHAT_PLAYER_NOT_BANNED_NOTICE     = 0x16,           //+ "[{}] Player {} is not bannedStore.";
    CHAT_PLAYER_ALREADY_MEMBER_NOTICE = 0x17,           //+ "[{}] Player {} is already on the channel.";
    CHAT_INVITE_NOTICE                = 0x18,           //+ "%2$s has invited you to join the channel '%1$s'.";
    CHAT_INVITE_WRONG_FACTION_NOTICE  = 0x19,           //+ "Target is in the wrong alliance for {}.";
    CHAT_WRONG_FACTION_NOTICE         = 0x1A,           //+ "Wrong alliance for {}.";
    CHAT_INVALID_NAME_NOTICE          = 0x1B,           //+ "Invalid channel name";
    CHAT_NOT_MODERATED_NOTICE         = 0x1C,           //+ "{} is not moderated";
    CHAT_PLAYER_INVITED_NOTICE        = 0x1D,           //+ "[{}] You invited {} to join the channel";
    CHAT_PLAYER_INVITE_BANNED_NOTICE  = 0x1E,           //+ "[{}] {} has been bannedStore.";
    CHAT_THROTTLED_NOTICE             = 0x1F,           //+ "[{}] The number of messages that can be sent to this channel is limited, please wait to send another message.";
    CHAT_NOT_IN_AREA_NOTICE           = 0x20,           //+ "[{}] You are not in the correct area for this channel."; -- The user is trying to send a chat to a zone specific channel, and they're not physically in that zone.
    CHAT_NOT_IN_LFG_NOTICE            = 0x21,           //+ "[{}] You must be queued in looking for group before joining this channel."; -- The user must be in the looking for group system to join LFG chat channels.
    CHAT_VOICE_ON_NOTICE              = 0x22,           //+ "[{}] Channel voice enabled by {}.";
    CHAT_VOICE_OFF_NOTICE             = 0x23            //+ "[{}] Channel voice disabled by {}.";
};
