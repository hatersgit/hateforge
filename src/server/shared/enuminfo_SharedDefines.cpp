...
template <>
AC_API_EXPORT size_t EnumUtils<Races>::Count() { return 32; }
...
AC_API_EXPORT EnumText EnumUtils<Classes>::ToString(Classes value)
{
    switch (value)
    {
        ...
        case CLASS_SHAPESHIFTER: return { "CLASS_SHAPESHIFTER", "Shapeshifter", "" };
...
AC_API_EXPORT Classes EnumUtils<Classes>::FromIndex(size_t index)
{
    switch (index)
    {
        ...
        case 11: return CLASS_SHAPESHIFTER;
        case 12: return CLASS_BARD;
        case 13: return CLASS_TINKER;
        default: throw std::out_of_range("index");
    }
}
...
AC_API_EXPORT size_t EnumUtils<Classes>::ToIndex(Classes value)
{
    switch (value)
    {
        ...
        case CLASS_SHAPESHIFTER: return 11;
        case CLASS_BARD: return 12;
        case CLASS_TINKER: return 13;
        default: throw std::out_of_range("value");
    }
}
