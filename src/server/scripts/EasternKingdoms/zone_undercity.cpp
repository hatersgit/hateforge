            ...
            switch (waveId)
            {
                ...
                case 6:
                    if (Unit* temp = me->SummonCreature(NPC_BLIGHTWORM, AllianceSpawn[7].x, AllianceSpawn[7].y, AllianceSpawn[7].z, TEMPSUMMON_MANUAL_DESPAWN))
                    {
                        ...
                        temp->GetThreatManager().AddThreat(me, 100.0f);
                        me->GetThreatManager().AddThreat(temp, 100.0f);
                        if (Creature* jaina = ObjectAccessor::GetCreature(*me, jainaGUID))
                        {
                            temp->GetThreatManager().AddThreat(jaina, 100.0f);
                            jaina->GetThreatManager().AddThreat(temp, 100.0f);
                        }
                    }
                    ...
                    switch (step)
                    {
                        ...
                        case 53:
                            if (Creature* putress = ObjectAccessor::GetCreature(*me, putressGUID))
                            {
                                ...
                                putress->GetThreatManager().AddThreat(me, 100.0f);
                                me->GetThreatManager().AddThreat(putress, 100.0f);
                        ...
                        case 73:
                            ...
                            if (Creature* thrall = ObjectAccessor::GetCreature(*me, thrallGUID))
                            {
                                ...
                                thrall->GetThreatManager().AddThreat(me, 100.0f);
                                me->GetThreatManager().AddThreat(thrall, 100.0f);
                            ...
                            if (Creature* sylvanas = ObjectAccessor::GetCreature(*me, sylvanasGUID))
                            {
                                ...
                                sylvanas->GetThreatManager().AddThreat(me, 100.0f);
                                sylvanas->AI()->AttackStart(me);
                                me->GetThreatManager().AddThreat(sylvanas, 100.0f);
                            }
                            for (uint8 i = 0; i < HORDE_FORCE_MAXCOUNT; ++i)
                            {
                                if (Creature* temp = ObjectAccessor::GetCreature(*me, hordeForcesGUID[i]))
                            ...
                            for (uint8 i = 0; i < ALLIANCE_FORCE_MAXCOUNT; ++i)
                            {
                                if (Creature* temp = ObjectAccessor::GetCreature(*me, allianceForcesGUID[i]))
                                {
                                    if (Creature* temp2 = ObjectAccessor::GetCreature(*me, hordeForcesGUID[i]))
                                    {
                                        ...
                                        temp->GetThreatManager().AddThreat(temp2, 100.0f);
                                        temp->AI()->AttackStart(temp2);
                                        temp2->GetThreatManager().AddThreat(temp, 100.0f);
                                    }
                                }
                            }
                            JumpToNextStep(6 * IN_MILLISECONDS);
        ...
        void JustSummoned(Creature* summoned) override
        {
            switch (summoned->GetEntry())
            {
                ...
                case NPC_CHEMIST_H:
                    ...
                    summoned->GetThreatManager().AddThreat(me, 100.0f);
                    me->GetThreatManager().AddThreat(summoned, 100.0f);
                    summoned->AI()->AttackStart(me);
                    break;
                    ...
                    switch (step)
                    {
                        ...
                        case 137:
                            if (Creature* valimathras = ObjectAccessor::GetCreature(*me, ValimathrasGUID))
                            {
                                ...
                                valimathras->GetThreatManager().AddThreat(me, 100.0f);
                                me->GetThreatManager().AddThreat(valimathras, 100.0f);
                        ...
                        case 152:
                            ...
                            if (Creature* wrynn = ObjectAccessor::GetCreature(*me, WrynnGUID))
                            {
                                ...
                                wrynn->GetThreatManager().AddThreat(me, 100.0f);
                                me->GetThreatManager().AddThreat(wrynn, 100.0f);
