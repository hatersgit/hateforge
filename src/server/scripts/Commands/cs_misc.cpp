...
public:
    ...
    ChatCommandTable GetCommands() const override
    {
        ...
        {
            { "commentator",       HandleCommentatorCommand,       SEC_TRIAL_GAMEMASTER,          Console::No  },
            { "dev",               HandleDevCommand,               SEC_OWNER,      Console::No  },
            { "gps",               HandleGPSCommand,               SEC_TRIAL_GAMEMASTER,          Console::No  },
            { "aura",              HandleAuraCommand,              SEC_GAMEMASTER1,         Console::No  },
            { "unaura",            HandleUnAuraCommand,            SEC_GAMEMASTER1,         Console::No  },
            { "appear",            HandleAppearCommand,            SEC_TRIAL_GAMEMASTER,          Console::No  },
            { "summon",            HandleSummonCommand,            SEC_GAMEMASTER1,         Console::No  },
            { "groupsummon",       HandleGroupSummonCommand,       SEC_GAMEMASTER1,         Console::No  },
            { "commands",          HandleCommandsCommand,          SEC_PLAYER,             Console::Yes },
            { "die",               HandleDieCommand,               SEC_GAMEMASTER1,         Console::No  },
            { "revive",            HandleReviveCommand,            SEC_GAMEMASTER1,         Console::Yes },
            { "dismount",          HandleDismountCommand,          SEC_PLAYER,             Console::No  },
            { "guid",              HandleGUIDCommand,              SEC_GAMEMASTER1,         Console::No  },
            { "help",              HandleHelpCommand,              SEC_PLAYER,             Console::Yes },
            { "cooldown",          HandleCooldownCommand,          SEC_GAMEMASTER1,         Console::No  },
            { "distance",          HandleGetDistanceCommand,       SEC_GAMEMASTER2_L,      Console::No  },
            { "recall",            HandleRecallCommand,            SEC_GAMEMASTER1,         Console::No  },
            { "save",              HandleSaveCommand,              SEC_PLAYER,             Console::No  },
            { "saveall",           HandleSaveAllCommand,           SEC_GAMEMASTER1,         Console::Yes },
            { "kick",              HandleKickPlayerCommand,        SEC_GAMEMASTER1,         Console::Yes },
            { "unstuck",           HandleUnstuckCommand,           SEC_GAMEMASTER1,         Console::Yes },
            { "linkgrave",         HandleLinkGraveCommand,         SEC_GAMEMASTER2_F,      Console::No  },
            { "neargrave",         HandleNearGraveCommand,         SEC_GAMEMASTER1,         Console::No  },
            { "showarea",          HandleShowAreaCommand,          SEC_GAMEMASTER1,         Console::No  },
            { "hidearea",          HandleHideAreaCommand,          SEC_GAMEMASTER2_F,      Console::No  },
            { "additem",           HandleAddItemCommand,           SEC_GAMEMASTER1,         Console::Yes },
            { "additem set",       HandleAddItemSetCommand,        SEC_GAMEMASTER1,         Console::No  },
            { "wchange",           HandleChangeWeather,            SEC_GAMEMASTER2_F,      Console::No  },
            { "maxskill",          HandleMaxSkillCommand,          SEC_GAMEMASTER1,         Console::No  },
            { "setskill",          HandleSetSkillCommand,          SEC_GAMEMASTER1,         Console::No  },
            { "pinfo",             HandlePInfoCommand,             SEC_GAMEMASTER1,         Console::Yes },
            { "respawn",           HandleRespawnCommand,           SEC_GAMEMASTER1,         Console::No  },
            { "respawn all",       HandleRespawnAllCommand,        SEC_GAMEMASTER1,         Console::No  },
            { "mute",              HandleMuteCommand,              SEC_GAMEMASTER1,         Console::Yes },
            { "mutehistory",       HandleMuteInfoCommand,          SEC_GAMEMASTER1,         Console::Yes },
            { "unmute",            HandleUnmuteCommand,            SEC_GAMEMASTER1,         Console::Yes },
            { "movegens",          HandleMovegensCommand,          SEC_GAMEMASTER2_F,      Console::No  },
            { "cometome",          HandleComeToMeCommand,          SEC_GAMEMASTER2_F,      Console::No  },
            { "damage",            HandleDamageCommand,            SEC_GAMEMASTER1,         Console::No  },
            { "combatstop",        HandleCombatStopCommand,        SEC_GAMEMASTER1,         Console::Yes },
            { "flusharenapoints",  HandleFlushArenaPointsCommand,  SEC_GAMEMASTER2_F,      Console::Yes  },
            { "freeze",            HandleFreezeCommand,            SEC_GAMEMASTER1,         Console::No  },
            { "unfreeze",          HandleUnFreezeCommand,          SEC_GAMEMASTER1,         Console::No  },
            { "possess",           HandlePossessCommand,           SEC_GAMEMASTER1,         Console::No  },
            { "unpossess",         HandleUnPossessCommand,         SEC_GAMEMASTER1,         Console::No  },
            { "bindsight",         HandleBindSightCommand,         SEC_GAMEMASTER2_L,      Console::No  },
            { "unbindsight",       HandleUnbindSightCommand,       SEC_GAMEMASTER2_L,      Console::No  },
            { "playall",           HandlePlayAllCommand,           SEC_GAMEMASTER1,         Console::No  },
            { "skirmish",          HandleSkirmishCommand,          SEC_GAMEMASTER2_F,      Console::No  },
            { "mailbox",           HandleMailBoxCommand,           SEC_TRIAL_GAMEMASTER,          Console::No  },
            { "string",            HandleStringCommand,            SEC_GAMEMASTER1,         Console::No  }
        };
    ...
    static bool HandleSaveCommand(ChatHandler* handler)
    {
        ...
        if (handler->GetSession()->GetSecurity() >= SEC_GAMEMASTER1)
        {
