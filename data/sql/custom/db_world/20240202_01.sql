CREATE TABLE IF NOT EXISTS acore_characters.`custom_item_template` (
  ...
  `itemSlotValue` float unsigned NOT NULL,
  `dmg_min1_max` float NOT NULL DEFAULT '0',
  `dmg_max1_max` float NOT NULL DEFAULT '0',
  `dmg_min2_max` float NOT NULL DEFAULT '0',
  `dmg_max2_max` float NOT NULL DEFAULT '0',
