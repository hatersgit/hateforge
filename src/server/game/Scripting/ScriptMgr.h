...
public: /* PlayerScript */
    ...
    void BeforeEquip(Player* player, Item* it, uint8 bag, uint8 slot, bool update);
    ...
    void GenerateItem(CustomItemTemplate* itemProto, Player const* owner, float ilvlMod = 0.f, bool complete = false);
