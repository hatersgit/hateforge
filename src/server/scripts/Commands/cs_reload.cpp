...
public:
    ...
    ChatCommandTable GetCommands() const override
    {
        ...
        {
            { "achievement",                   HandleReloadAllAchievementCommand,             SEC_GAMEMASTER2_F, Console::Yes },
            { "area",                          HandleReloadAllAreaCommand,                    SEC_GAMEMASTER2_F, Console::Yes },
            { "gossips",                       HandleReloadAllGossipsCommand,                 SEC_GAMEMASTER2_F, Console::Yes },
            { "item",                          HandleReloadAllItemCommand,                    SEC_GAMEMASTER2_F, Console::Yes },
            { "locales",                       HandleReloadAllLocalesCommand,                 SEC_GAMEMASTER2_F, Console::Yes },
            { "loot",                          HandleReloadAllLootCommand,                    SEC_GAMEMASTER2_F, Console::Yes },
            { "npc",                           HandleReloadAllNpcCommand,                     SEC_GAMEMASTER2_F, Console::Yes },
            { "quest",                         HandleReloadAllQuestCommand,                   SEC_GAMEMASTER2_F, Console::Yes },
            { "scripts",                       HandleReloadAllScriptsCommand,                 SEC_GAMEMASTER2_F, Console::Yes },
            { "spell",                         HandleReloadAllSpellCommand,                   SEC_GAMEMASTER2_F, Console::Yes },
            { "",                              HandleReloadAllCommand,                        SEC_GAMEMASTER2_F, Console::Yes },
        };
        static ChatCommandTable reloadCommandTable =
        {
            { "auctions",                      HandleReloadAuctionsCommand,                   SEC_GAMEMASTER2_F, Console::Yes },
            { "dungeon_access_template",       HandleReloadDungeonAccessCommand,              SEC_GAMEMASTER2_F, Console::Yes },
            { "dungeon_access_requirements",   HandleReloadDungeonAccessCommand,              SEC_GAMEMASTER2_F, Console::Yes },
            { "achievement_criteria_data",     HandleReloadAchievementCriteriaDataCommand,    SEC_GAMEMASTER2_F, Console::Yes },
            { "achievement_reward",            HandleReloadAchievementRewardCommand,          SEC_GAMEMASTER2_F, Console::Yes },
            { "all", reloadAllCommandTable },
            { "areatrigger",                   HandleReloadQuestAreaTriggersCommand,          SEC_GAMEMASTER2_F, Console::Yes },
            { "areatrigger_involvedrelation",  HandleReloadQuestAreaTriggersCommand,          SEC_GAMEMASTER2_F, Console::Yes },
            { "areatrigger_tavern",            HandleReloadAreaTriggerTavernCommand,          SEC_GAMEMASTER2_F, Console::Yes },
            { "areatrigger_teleport",          HandleReloadAreaTriggerTeleportCommand,        SEC_GAMEMASTER2_F, Console::Yes },
            { "autobroadcast",                 HandleReloadAutobroadcastCommand,              SEC_GAMEMASTER2_F, Console::Yes },
            { "motd",                          HandleReloadMotdCommand,                       SEC_GAMEMASTER2_F, Console::Yes },
            { "broadcast_text",                HandleReloadBroadcastTextCommand,              SEC_GAMEMASTER2_F, Console::Yes },
            { "battleground_template",         HandleReloadBattlegroundTemplate,              SEC_GAMEMASTER2_F, Console::Yes },
            { "command",                       HandleReloadCommandCommand,                    SEC_GAMEMASTER2_F, Console::Yes },
            { "conditions",                    HandleReloadConditions,                        SEC_GAMEMASTER2_F, Console::Yes },
            { "config",                        HandleReloadConfigCommand,                     SEC_GAMEMASTER2_F, Console::Yes },
            { "creature_text",                 HandleReloadCreatureText,                      SEC_GAMEMASTER2_F, Console::Yes },
            { "creature_questender",           HandleReloadCreatureQuestEnderCommand,         SEC_GAMEMASTER2_F, Console::Yes },
            { "creature_linked_respawn",       HandleReloadLinkedRespawnCommand,              SEC_GAMEMASTER2_F, Console::Yes },
            { "creature_loot_template",        HandleReloadLootTemplatesCreatureCommand,      SEC_GAMEMASTER2_F, Console::Yes },
            { "creature_movement_override",     HandleReloadCreatureMovementOverrideCommand,    SEC_GAMEMASTER2_F, Console::Yes},
            { "creature_onkill_reputation",     HandleReloadOnKillReputationCommand,           SEC_GAMEMASTER2_F, Console::Yes },
            { "creature_queststarter",         HandleReloadCreatureQuestStarterCommand,       SEC_GAMEMASTER2_F, Console::Yes },
            { "creature_template",             HandleReloadCreatureTemplateCommand,           SEC_GAMEMASTER2_F, Console::Yes },
            { "disables",                      HandleReloadDisablesCommand,                   SEC_GAMEMASTER2_F, Console::Yes },
            { "disenchant_loot_template",      HandleReloadLootTemplatesDisenchantCommand,    SEC_GAMEMASTER2_F, Console::Yes },
            { "event_scripts",                 HandleReloadEventScriptsCommand,               SEC_GAMEMASTER2_F, Console::Yes },
            { "fishing_loot_template",         HandleReloadLootTemplatesFishingCommand,       SEC_GAMEMASTER2_F, Console::Yes },
            { "game_graveyard",                HandleReloadGameGraveyardCommand,              SEC_GAMEMASTER2_F, Console::Yes },
            { "graveyard_zone",                HandleReloadGameGraveyardZoneCommand,          SEC_GAMEMASTER2_F, Console::Yes },
            { "game_tele",                     HandleReloadGameTeleCommand,                   SEC_GAMEMASTER2_F, Console::Yes },
            { "gameobject_questender",         HandleReloadGOQuestEnderCommand,               SEC_GAMEMASTER2_F, Console::Yes },
            { "gameobject_loot_template",      HandleReloadLootTemplatesGameobjectCommand,    SEC_GAMEMASTER2_F, Console::Yes },
            { "gameobject_queststarter",       HandleReloadGOQuestStarterCommand,             SEC_GAMEMASTER2_F, Console::Yes },
            { "gm_tickets",                    HandleReloadGMTicketsCommand,                  SEC_GAMEMASTER2_F, Console::Yes },
            { "gossip_menu",                   HandleReloadGossipMenuCommand,                 SEC_GAMEMASTER2_F, Console::Yes },
            { "gossip_menu_option",            HandleReloadGossipMenuOptionCommand,           SEC_GAMEMASTER2_F, Console::Yes },
            { "item_enchantment_template",     HandleReloadItemEnchantementsCommand,          SEC_GAMEMASTER2_F, Console::Yes },
            { "item_loot_template",            HandleReloadLootTemplatesItemCommand,          SEC_GAMEMASTER2_F, Console::Yes },
            { "item_set_names",                HandleReloadItemSetNamesCommand,               SEC_GAMEMASTER2_F, Console::Yes },
            { "lfg_dungeon_rewards",           HandleReloadLfgRewardsCommand,                 SEC_GAMEMASTER2_F, Console::Yes },
            { "achievement_reward_locale",     HandleReloadLocalesAchievementRewardCommand,   SEC_GAMEMASTER2_F, Console::Yes },
            { "creature_template_locale",      HandleReloadLocalesCreatureCommand,            SEC_GAMEMASTER2_F, Console::Yes },
            { "creature_text_locale",          HandleReloadLocalesCreatureTextCommand,        SEC_GAMEMASTER2_F, Console::Yes },
            { "gameobject_template_locale",    HandleReloadLocalesGameobjectCommand,          SEC_GAMEMASTER2_F, Console::Yes },
            { "gossip_menu_option_locale",     HandleReloadLocalesGossipMenuOptionCommand,    SEC_GAMEMASTER2_F, Console::Yes },
            { "item_template_locale",          HandleReloadLocalesItemCommand,                SEC_GAMEMASTER2_F, Console::Yes },
            { "item_set_name_locale",          HandleReloadLocalesItemSetNameCommand,         SEC_GAMEMASTER2_F, Console::Yes },
            { "npc_text_locale",               HandleReloadLocalesNpcTextCommand,             SEC_GAMEMASTER2_F, Console::Yes },
            { "page_text_locale",              HandleReloadLocalesPageTextCommand,            SEC_GAMEMASTER2_F, Console::Yes },
            { "points_of_interest_locale",     HandleReloadLocalesPointsOfInterestCommand,    SEC_GAMEMASTER2_F, Console::Yes },
            { "quest_template_locale",         HandleReloadLocalesQuestCommand,               SEC_GAMEMASTER2_F, Console::Yes },
            { "quest_offer_reward_locale",     HandleReloadLocalesQuestOfferRewardCommand,    SEC_GAMEMASTER2_F, Console::Yes },
            { "quest_request_item_locale",     HandleReloadLocalesQuestRequestItemsCommand,   SEC_GAMEMASTER2_F, Console::Yes },
            { "mail_level_reward",             HandleReloadMailLevelRewardCommand,            SEC_GAMEMASTER2_F, Console::Yes },
            { "mail_loot_template",            HandleReloadLootTemplatesMailCommand,          SEC_GAMEMASTER2_F, Console::Yes },
            { "mail_server_template",          HandleReloadMailServerTemplateCommand,         SEC_GAMEMASTER2_F, Console::Yes },
            { "milling_loot_template",         HandleReloadLootTemplatesMillingCommand,       SEC_GAMEMASTER2_F, Console::Yes },
            { "npc_spellclick_spells",         HandleReloadSpellClickSpellsCommand,           SEC_GAMEMASTER2_F, Console::Yes },
            { "npc_trainer",                   HandleReloadNpcTrainerCommand,                 SEC_GAMEMASTER2_F, Console::Yes },
            { "npc_vendor",                    HandleReloadNpcVendorCommand,                  SEC_GAMEMASTER2_F, Console::Yes },
            { "page_text",                     HandleReloadPageTextsCommand,                  SEC_GAMEMASTER2_F, Console::Yes },
            { "pickpocketing_loot_template",   HandleReloadLootTemplatesPickpocketingCommand, SEC_GAMEMASTER2_F, Console::Yes },
            { "points_of_interest",            HandleReloadPointsOfInterestCommand,           SEC_GAMEMASTER2_F, Console::Yes },
            { "prospecting_loot_template",     HandleReloadLootTemplatesProspectingCommand,   SEC_GAMEMASTER2_F, Console::Yes },
            { "quest_greeting",                HandleReloadQuestGreetingCommand,              SEC_GAMEMASTER2_F, Console::Yes },
            { "quest_greeting_locale",         HandleReloadLocalesQuestGreetingCommand,       SEC_GAMEMASTER2_F, Console::Yes },
            { "quest_poi",                     HandleReloadQuestPOICommand,                   SEC_GAMEMASTER2_F, Console::Yes },
            { "quest_template",                HandleReloadQuestTemplateCommand,              SEC_GAMEMASTER2_F, Console::Yes },
            { "reference_loot_template",       HandleReloadLootTemplatesReferenceCommand,     SEC_GAMEMASTER2_F, Console::Yes },
            { "reserved_name",                 HandleReloadReservedNameCommand,               SEC_GAMEMASTER2_F, Console::Yes },
            { "profanity_name",                HandleReloadProfanityNameCommand,              SEC_GAMEMASTER2_F, Console::Yes },
            { "reputation_reward_rate",        HandleReloadReputationRewardRateCommand,       SEC_GAMEMASTER2_F, Console::Yes },
            { "reputation_spillover_template", HandleReloadReputationRewardRateCommand,       SEC_GAMEMASTER2_F, Console::Yes },
            { "skill_discovery_template",      HandleReloadSkillDiscoveryTemplateCommand,     SEC_GAMEMASTER2_F, Console::Yes },
            { "skill_extra_item_template",     HandleReloadSkillExtraItemTemplateCommand,     SEC_GAMEMASTER2_F, Console::Yes },
            { "skill_fishing_base_level",      HandleReloadSkillFishingBaseLevelCommand,      SEC_GAMEMASTER2_F, Console::Yes },
            { "skinning_loot_template",        HandleReloadLootTemplatesSkinningCommand,      SEC_GAMEMASTER2_F, Console::Yes },
            { "smart_scripts",                 HandleReloadSmartScripts,                      SEC_GAMEMASTER2_F, Console::Yes },
            { "spell_required",                HandleReloadSpellRequiredCommand,              SEC_GAMEMASTER2_F, Console::Yes },
            { "spell_area",                    HandleReloadSpellAreaCommand,                  SEC_GAMEMASTER2_F, Console::Yes },
            { "spell_bonus_data",              HandleReloadSpellBonusesCommand,               SEC_GAMEMASTER2_F, Console::Yes },
            { "spell_group",                   HandleReloadSpellGroupsCommand,                SEC_GAMEMASTER2_F, Console::Yes },
            { "spell_loot_template",           HandleReloadLootTemplatesSpellCommand,         SEC_GAMEMASTER2_F, Console::Yes },
            { "spell_linked_spell",            HandleReloadSpellLinkedSpellCommand,           SEC_GAMEMASTER2_F, Console::Yes },
            { "spell_pet_auras",               HandleReloadSpellPetAurasCommand,              SEC_GAMEMASTER2_F, Console::Yes },
            { "spell_proc_event",              HandleReloadSpellProcEventCommand,             SEC_GAMEMASTER2_F, Console::Yes },
            { "spell_proc",                    HandleReloadSpellProcsCommand,                 SEC_GAMEMASTER2_F, Console::Yes },
            { "spell_scripts",                 HandleReloadSpellScriptsCommand,               SEC_GAMEMASTER2_F, Console::Yes },
            { "spell_target_position",         HandleReloadSpellTargetPositionCommand,        SEC_GAMEMASTER2_F, Console::Yes },
            { "spell_threats",                 HandleReloadSpellThreatsCommand,               SEC_GAMEMASTER2_F, Console::Yes },
            { "spell_group_stack_rules",       HandleReloadSpellGroupStackRulesCommand,       SEC_GAMEMASTER2_F, Console::Yes },
            { "player_loot_template",          HandleReloadLootTemplatesPlayerCommand,        SEC_GAMEMASTER2_F, Console::Yes },
            { "acore_string",                  HandleReloadAcoreStringCommand,                SEC_GAMEMASTER2_F, Console::Yes },
            { "warden_action",                 HandleReloadWardenactionCommand,               SEC_GAMEMASTER2_F, Console::Yes },
            { "waypoint_scripts",              HandleReloadWpScriptsCommand,                  SEC_GAMEMASTER2_F, Console::Yes },
            { "waypoint_data",                 HandleReloadWpCommand,                         SEC_GAMEMASTER2_F, Console::Yes },
            { "vehicle_accessory",             HandleReloadVehicleAccessoryCommand,           SEC_GAMEMASTER2_F, Console::Yes },
            { "vehicle_template_accessory",    HandleReloadVehicleTemplateAccessoryCommand,   SEC_GAMEMASTER2_F, Console::Yes },
            { "creature_template_outfits",     HandleReloadCreatureTemplateOutfitsCommand,    SEC_GAMEMASTER2_F, Console::Yes },
        };
    ...
    static bool HandleReloadCreatureTemplateOutfitsCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage("Creature template outfits reloaded.");
        return true;
    }
