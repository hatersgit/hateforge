...
{
    TALENT_TREE_WARRIOR_ARMS			 = 1,
	TALENT_TREE_WARRIOR_FURY			 = 2,
	TALENT_TREE_WARRIOR_PROTECTION		 = 3,
	TALENT_TREE_PALADIN_HOLY			 = 4,
	TALENT_TREE_PALADIN_PROTECTION		 = 5,
	TALENT_TREE_PALADIN_RETRIBUTION		 = 6,
	TALENT_TREE_HUNTER_BEAST_MASTERY	 = 7,
	TALENT_TREE_HUNTER_MARKSMANSHIP		 = 8,
	TALENT_TREE_HUNTER_SURVIVAL			 = 9,
	TALENT_TREE_ROGUE_ASSASSINATION		 = 10,
	TALENT_TREE_ROGUE_COMBAT			 = 11,
	TALENT_TREE_ROGUE_SUBTLETY			 = 12,
    TALENT_TREE_PRIEST_HOLY              = 13,
	TALENT_TREE_PRIEST_DISCIPLINE		 = 14,
	TALENT_TREE_PRIEST_SHADOW			 = 15,
	TALENT_TREE_DEATH_KNIGHT_BLOOD		 = 16,
	TALENT_TREE_DEATH_KNIGHT_FROST		 = 17,
	TALENT_TREE_DEATH_KNIGHT_UNHOLY		 = 18,
	TALENT_TREE_SHAMAN_ELEMENTAL		 = 19,
	TALENT_TREE_SHAMAN_ENHANCEMENT		 = 20,
	TALENT_TREE_SHAMAN_RESTORATION		 = 21,
	TALENT_TREE_MAGE_ARCANE				 = 22,
	TALENT_TREE_MAGE_FIRE				 = 23,
	TALENT_TREE_MAGE_FROST				 = 24,
	TALENT_TREE_WARLOCK_AFFLICTION		 = 25,
	TALENT_TREE_WARLOCK_DEMONOLOGY		 = 26,
	TALENT_TREE_WARLOCK_DESTRUCTION		 = 27,
	TALENT_TREE_DRUID_BALANCE			 = 28,
	TALENT_TREE_DRUID_FERAL_COMBAT		 = 29,
	TALENT_TREE_DRUID_RESTORATION		 = 30,

    TALENT_TREE_DRUID_GUARDIAN           = 31,
    TALENT_TREE_PRIEST_INQUISITION       = 32,
    TALENT_TREE_SHAMAN_WATCHER           = 33,

    TALENT_TREE_DEMON_HUNTER_ANGUISH     = 34,     // Unused for now
    TALENT_TREE_DEMON_HUNTER_HAVOC       = 35,
    TALENT_TREE_DEMON_HUNTER_VENGEANCE   = 36,
    TALENT_TREE_MONK_FELLOWSHIP          = 37,
    TALENT_TREE_MONK_RADIANCE            = 38,
    TALENT_TREE_MONK_ZEALOTRY            = 39,
	TALENT_TREE_BARD_BLADESONG			 = 40,     // Unused for now
	TALENT_TREE_BARD_INSPIRATION		 = 41,     // Melody
	TALENT_TREE_BARD_SONGWEAVER			 = 42,     // Rhapsody
    TALENT_TREE_TINKER_PHYSICIAN		 = 43,
	TALENT_TREE_TINKER_SCRAPPER			 = 44,     // Technician
	TALENT_TREE_TINKER_VANGUARD			 = 45,
};
...
public:
    ...
    void postCheckRemoveSpell(uint32 spell_id);
    void resetSpells();
    ...
    template <class T>
    void ApplySpellMod(const SpellInfo* const spellInfo, SpellModOp op, T& basevalue, Spell* spell = nullptr) const {
        return ApplySpellMod(spellInfo->Id, op, basevalue, spell);
    }
