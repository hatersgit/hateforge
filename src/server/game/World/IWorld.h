...
enum Rates
{
    ...
    RATE_POWER_BATTERYGAUGE_INCOME,
    RATE_POWER_BATTERYGAUGE_LOSS,
    RATE_POWER_DISCORD_INCOME,
    RATE_POWER_DISCORD_LOSS,
    RATE_POWER_FURY_INCOME,
    RATE_POWER_FURY_LOSS,
    RATE_POWER_HARMONY_INCOME,
    RATE_POWER_HARMONY_LOSS,
    RATE_POWER_INSANITY_INCOME,
    RATE_POWER_INSANITY_LOSS,
    RATE_POWER_WRATH_INCOME,
    RATE_POWER_WRATH_LOSS,
    MAX_RATES
};
