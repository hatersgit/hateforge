...
enum Texts
{
    ...
    EMOTE_WARN_BLISTERING_COLD          = 2, // {} prepares to unleash a wave of blistering cold!
    ...
    EMOTE_WARN_FROZEN_ORB               = 7, // {} fires a frozen orb towards $N!
    SAY_KILL                            = 8, // Perish!
    // A flaw of mortality...
    SAY_BERSERK                         = 9, // Enough! I tire of these games!
    SAY_DEATH                           = 10, // Free...at last...
    EMOTE_BERSERK_RAID                  = 11,
    EMOTE_WEAKENING                     = 101, // {} appears to be weakening!
};
