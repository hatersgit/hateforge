...
public:
    ...
    virtual void BeforeEquip(Player* /*player*/, Item* /*it*/, uint8 /*bag*/, uint8 /*slot*/, bool /*update*/) { }
    ...
    virtual void GenerateItem(CustomItemTemplate* itemProto, Player const* owner, float ilvlmod, bool complete) { }
